# DiusCodingPractice
This is a basic project as a code practice, there might be some similarities with open-source codes on the Internet.

There are two main packages including main and test. Main holds the actual business logic and the test one contains all the unit tests.
